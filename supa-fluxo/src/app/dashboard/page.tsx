...
export default function DashboardPage() {
  ...
  useEffect(() => {
    (async () => {
      ...
      const { data, error } = await supabase
        .from("surveys")
        .select("id,status,created_by,requester,needed_date,admin_deadline,completed_at,assets(code,title),urgent")
  ...
  return (
    <div style={{ display: "grid", gap: 12 }}>
      <div className="card">
        <div className="cardTitle">Dashboard Geral</div>
        <div className="small">
          {isAdmin
            ? ""
      ...
      <div className="card">
        ...
        <div className="small">Todas as solicitações (todas as empresas). As suas ficam destacadas.</div>
